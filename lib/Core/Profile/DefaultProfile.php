...
use Check\Core\Auth\Credential;
use Check\Core\Auth\ShaHmac1Signer;
use Check\Core\Regions\ProductDomain;
use Check\Core\Regions\Endpoint;
use Check\Core\Regions\EndpointProvider;
